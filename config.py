...
BACKEND = os.getenv('ERRBOT_BACKEND', 'XMPP')  # defaults to XMPP
...
BOT_IDENTITY = {
    # XMPP (Jabber) mode
    'username': os.getenv('ERRBOT_USERNAME', 'err@localhost'),  # The JID of the user you have created for the bot
    'password': os.getenv('ERRBOT_PASSWORD', 'changeme')       # The corresponding password for this user
...
BOT_ADMINS = os.getenv('ERRBOT_ADMINS', 'gbin@localhost').split(",")
